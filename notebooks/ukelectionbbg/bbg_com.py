...
"""
    Thalesians Ltd (www.thalesians.com) please contact saeed@thalesians.com for further information
    You are free to modify and distribute this code as you see fit provided this source is cited
"""

"""
methods for using the bbg COM API v3 from python
Written by Brian P. Smith (brian.p.smith@gmail.com)

(modified by Saeed Amen (saeed@thalesians.com) for Python 3.4)
"""
...
if __name__ == '__main__':
    ...
    # HOW TO
    #
    # - Retrieve an fx vol surface:  ReferenceDataRequest('eurusd curncy', 'DFLT_VOL_SURF_MID')
    # - Retrieve a fx forward curve:  ReferenceDataRequest('eurusd curncy', 'FWD_CURVE')
    # - Retrieve dividends:  ReferenceDataRequest('csco us equity', 'BDVD_PR_EX_DTS_DVD_AMTS_W_ANN')